  ...
  const borderWidth: JSX.Element = 
    <div className="palette__element palette__element_ico ico_borderWidth" 
      onMouseDown = {(e) => {
        ...
        setValuePopup({ 
          items: [
            {caption: '0 пикс', action: () => props.changeShapeObj('0' ,'borderWidth')},
            {caption: '1 пикс.', action: () => props.changeShapeObj('1' ,'borderWidth')},  
            {caption: '5 пикс.', action: () => props.changeShapeObj('5' ,'borderWidth')},
            {caption: '10 пикс.', action: () => props.changeShapeObj('10' ,'borderWidth')},
            {caption: '15 пикс.', action: () => props.changeShapeObj('15' ,'borderWidth')},
            {caption: '20 пикс.', action: () => props.changeShapeObj('20' ,'borderWidth')}
          ],  
